...
CREATE INDEX idx_agents_online ON flowops.agents (is_online);
CREATE INDEX idx_agents_team   ON flowops.agents (team);

-- ============================================================
-- AGENT SKILLS
-- ============================================================
CREATE TABLE flowops.agent_skills (
...
CREATE INDEX idx_agent_skills_skill ON flowops.agent_skills (skill, skill_level DESC);

-- ============================================================
-- CASE ROUTING RULES
-- Maps each CaseType to a required skill
-- ============================================================
CREATE TABLE flowops.case_routing_rules (
...
INSERT INTO flowops.case_routing_rules (case_type, required_skill, min_skill_level) VALUES
    ...
    ('FRAUD_ALERT',      'fraud_investigation',   2),  -- min intermediate for fraud
...
INSERT INTO flowops.agent_skills (agent_id, skill, skill_level) VALUES
    ('AGT-001', 'billing',              3),  -- senior billing
    ('AGT-001', 'account_management',   2),
    ('AGT-002', 'fraud_investigation',  3),  -- senior fraud
    ('AGT-002', 'account_management',   1),
    ('AGT-003', 'fraud_investigation',  2),
    ('AGT-003', 'billing',              1),
    ('AGT-004', 'technical',            3),  -- senior technical
